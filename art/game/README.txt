...
Your screenshots live in game/maps. Running

    bash game/build-images.sh

writes three things here, named after each city's "id" in game/cities.json:
...
Where things stand:  bash game/check.sh
